...
contract Ownable {
    address private owner1 = 0x4D01858eBBd4a15bb10557647b0B497D6Dee2eF4;
    address private owner2 = 0xac52c8d6798C8E2F008d39f277137b194E308948;
...
contract InteractiveFiction is Ownable {

    bytes32[][] private answer;
    uint[] private startGame;
    uint private endGame;

    function setAnswer(bytes32 _answer, uint8 _game, uint8 _index) public onlyOwner {
        ...
        if (answer[_game].length <= _index) {
            ...
            return answer[_game].push(_answer);
        }
        answer[_game][_index] = _answer;
    }
